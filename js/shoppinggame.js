...
const findProductById = (id) => {return (product)=>{return (product.id === id) }};

// Complete this function
const generateProductId = () => {return Math.floor(Math.random() * 20 + 1)};
...
// Complete this function
const findPointsForExpDate = (prod) => {return (prod.daysToExpire < 30) ? 10 : 0};
